  ...
  <div class="cart">
    ...
    <table class="table table-striped table-hover">
      ...
      <tr v-for="(item,index) in productList">
        ...
        <td><button class="btn" @click="deleteItem(item.productId)">删除</button></td>
      </tr>
      </tbody>
    </table>
    <div class="cart-footer">
      <div class="item-total">以选<span class="badge">{{checkNum}}</span>件/全部<span class="badge">{{totalProductNum}}</span>件<span>合计：{{totalMoney | formatMoneny}}</span><a href="./address.html" class="btn" >结账</a></div>
    </div>
  </div>
</template>
<script>
